...
- 🏆 **微信虚拟支付** - 全平台统一使用微信官方虚拟支付（充值/会员购买）
...
**支付**
- 微信虚拟支付（wx.requestVirtualPayment）
- 微信支付 API v3（备用）
...
**微信虚拟支付合规化改造**
- ✅ 全平台统一使用微信虚拟支付（wx.requestVirtualPayment），移除普通微信支付代码路径
- ✅ 充值页面合规化：移除支付方式选择器，明确标注"微信虚拟支付"
- ✅ 会员页面合规化：按钮文字改为"虚拟支付开通/续费"
- ✅ 发丝描述优化：区分"剪刀发丝"（购买获得）和"梳子发丝"（充值赠送）
- ✅ 修复开发者模式下充值发丝加错卡槽问题（应加到剪刀卡槽）
- ✅ 修复开发者模式下会员续期不累计问题
- ✅ 通过微信审核
